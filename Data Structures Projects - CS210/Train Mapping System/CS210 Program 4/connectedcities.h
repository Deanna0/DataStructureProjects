...
public:
 ...
 static void populateReachableCitiesDFS(unordered_map<string, CityNode> cityGraph, string startingCity,vector<string> &reachableCity, vector<string> &visited);
 static bool compareByCityCode(CityNode city1, CityNode city2 );
 static bool compareByNumberOfReachableCities(CityNode city1, CityNode city2 );
  /**
  * <p>
  * Part A 
  * ---------------------------------------------------------------------------------------
